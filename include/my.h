...
*/
    ...
    void game(sfRenderWindow *windo, sfEvent event, sfSprite *but,
    sfSprite *w);
    ...
    void draw_sprite5(sfRenderWindow *w,
    sfVector2f poss_hearts, sfSprite *hearts);
    void draw_sprite6(sfRenderWindow *w,
    sfVector2f poss_hearts, sfSprite *hearts);
